/**
 * BreweryScene — Hops farming & Fruit Beer brewing.
 * Unlocked at Tier 4.
 */
...
const TOOL_DEFS = {
  brew_kettle: {
    id: 'brew_kettle', name: '🍺 Brew Kettle', icon: '🍺',
    description: 'Brew fruit ales with hops',
    costs: { wood: 10, stone: 8 }, constructionSecs: 18,
    recipeId: 'brew_beer',
  },
};
