...
const RESOURCE_DISPLAY = [
  ...
  { key: 'blueberry',      id: 'count-blueberry',  icon: '🫐', label: 'Blueberries',    tier: 1 },
  { key: 'cider_creek_blue', id: 'count-ccblue',    icon: '💧', label: 'Cider Creek Blue', tier: 1 },
  { key: 'bottled_cider_creek_blue', id: 'count-ccbluebottled', icon: '🫙', label: 'Bottled Cider Creek Blue', tier: 1 },
